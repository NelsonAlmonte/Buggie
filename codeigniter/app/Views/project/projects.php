    ...
    <div class="col-lg-3 col-md-4 col-sm-12 mb-4">
      <div class="card bg-complementary border border-0 rounded-4">
        <div class="position-relative">
          <div class="position-absolute top-0 end-0 mt-3 me-3">
            ...
            <ul class="dropdown-menu p-2">
              <li>
                <a class="dropdown-item text-white" href="<?=site_url('project/' . $project['slug'] .'/edit/'. $project['id'])?>">
        ...
        <div class="card-body p-4">
          <h4 class="card-title text-white mb-4"><?=esc($project['name'])?></h4>
          <div class="mb-4">
            <p class="mb-0">Last issue #1</p>
            <p class="mb-0">Last issue #2</p>
          </div>
        ...
        <a class="text-decoration-none text-white" href="<?=site_url('project/' . $project['slug'] .'/dashboard')?>">
          <div class="card-footer d-flex justify-content-center bg-complementary rounded-bottom-4 py-3 card-project">
            Dashboard
          </div>
        </a>
      </div>
